  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        <p style="text-align:center; color:red">¿Estas seguro que deseas eliminar este proveedor?</p></br> 
        <input type="text" id="proveedor" name="proveedor" style="text-transform: uppercase;  font-size: 1.5rem; font-weight:600; border: none;  text-align:center;" >
      </div>
